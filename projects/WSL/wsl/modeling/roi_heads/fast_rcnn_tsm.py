...
__all__ = ["fast_rcnn_inference", "TSMOutputLayers"]
...
class TSMOutputLayers(nn.Module):
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.cls = Linear(input_size, num_classes + num_classes_stuff - 1)
        self.det = Linear(input_size, num_classes + num_classes_stuff - 1)
